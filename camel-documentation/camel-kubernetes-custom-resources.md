...
The Kubernetes Custom Resources component is one of [Kubernetes
Components](#kubernetes-summary.adoc) which provides a producer to
execute Kubernetes Custom Resources operations and a consumer to consume
events related to Node objects.
