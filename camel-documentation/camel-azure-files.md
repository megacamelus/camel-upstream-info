...
to optimize *the single file using a fixed name* use case, it is
...
|Name|Description|Default|Type|
|---|---|---|---|
|account|The account to use||string|
|share|The share to use||string|
...
|sharedKey|Shared key (storage account key)||string|
