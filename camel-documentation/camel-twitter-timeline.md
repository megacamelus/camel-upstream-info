...
The Twitter Timeline component consumes twitter timeline or updates the
...
|Name|Description|Default|Type|
|---|---|---|---|
|timelineType|The timeline type to produce/consume.||object|
|list|The list name when using timelineType=list||string|
|user|The username when using timelineType=user||string|
