...
The Zendesk component provides access to all the zendesk.com APIs
accessible using
[zendesk-java-client](https://github.com/cloudbees/zendesk-java-client).
It allows producing messages to manage Zendesk ticket, user,
organization, etc.
...
|---|---|---|---|
|serverUrl|The server URL to connect.||string|
...
|zendesk|To use a shared Zendesk instance.||object|
...
|Name|Description|Default|Type|
|---|---|---|---|
|methodName|What operation to use||object|
