...
use TemporaryQueue destinations or use a unique reply to destination per
InOut producer endpoint. The producer handles message correlation is
handled, not with message selectors at the broker.
